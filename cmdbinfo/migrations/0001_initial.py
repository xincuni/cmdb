    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_unit', models.ForeignKey(blank=True, null=True, on_delete=False, related_name='parent_level', to='cmdbinfo.BusinessUnit')),
            ],
            options={
                'verbose_name': '业务线',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=False, to='cmdbinfo.Asset')),
            ],
            options={
                'verbose_name': 'CPU部件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(blank=True, null=True)),
                ('asset', models.ForeignKey(on_delete=False, to='cmdbinfo.Asset')),
            ],
            options={
                'verbose_name': '硬盘',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sn', models.CharField(max_length=128, unique=True, verbose_name='资产SN号')),
                ('asset_type', models.CharField(blank=True, choices=[('server', '服务器'), ('switch', '交换机'), ('router', '路由器'), ('firewall', '防火墙'), ('storage', '存储设备'), ('software', '软件资产'), ('others', '其它类')], max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=False, to='cmdbinfo.Asset')),
                ('hosted_on', models.ForeignKey(blank=True, null=True, on_delete=False, related_name='hosted_on_server', to='cmdbinfo.Server')),
            ],
            options={
                'verbose_name': '服务器',
        ...
        migrations.AddField(
            model_name='tag',
            name='creater',
            field=models.ForeignKey(on_delete=False, to='cmdbinfo.UserProfile'),
        ),
        migrations.AddField(
            model_name='newassetapprovalzone',
            name='approved_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=False, to='cmdbinfo.UserProfile', verbose_name='批准人'),
        ),
        migrations.AddField(
            model_name='networkdevice',
            name='firmware',
            field=models.ForeignKey(blank=True, null=True, on_delete=False, to='cmdbinfo.Software'),
        ),
        migrations.AddField(
            model_name='eventlog',
            name='user',
            field=models.ForeignKey(on_delete=False, to='cmdbinfo.UserProfile', verbose_name='事件源'),
        ),
        migrations.AddField(
            model_name='asset',
            name='admin',
            field=models.ForeignKey(blank=True, null=True, on_delete=False, to='cmdbinfo.UserProfile', verbose_name='资产管理员'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=False, to='cmdbinfo.BusinessUnit', verbose_name='所属业务线'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
            field=models.ForeignKey(blank=True, null=True, on_delete=False, to='cmdbinfo.Contract', verbose_name='合同'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, null=True, on_delete=False, to='cmdbinfo.IDC', verbose_name='IDC机房'),
        ),
        migrations.AddField(
            model_name='asset',
            name='manufactory',
            field=models.ForeignKey(blank=True, null=True, on_delete=False, to='cmdbinfo.Manufactory', verbose_name='制造商'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tags',
            field=models.ManyToManyField(blank=True, to='cmdbinfo.Tag'),
        ),
