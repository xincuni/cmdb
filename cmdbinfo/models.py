...
class Asset(models.Model):
    ...
    manufactory = models.ForeignKey('Manufactory', verbose_name=u'制造商', null=True, blank=True, on_delete=False)
    management_ip = models.GenericIPAddressField(u'管理IP', blank=True, null=True)
    contract = models.ForeignKey('Contract', verbose_name=u'合同', null=True, blank=True, on_delete=False)
    trade_date = models.DateField(u'购买时间', null=True, blank=True)
    expire_date = models.DateField(u'过保修期', null=True, blank=True)
    price = models.FloatField(u'价格', null=True, blank=True)
    business_unit = models.ForeignKey('BusinessUnit', verbose_name=u'所属业务线', null=True, blank=True, on_delete=False)
    tags = models.ManyToManyField('Tag', blank=True)
    admin = models.ForeignKey('UserProfile', verbose_name=u'资产管理员', null=True, blank=True, on_delete=False)
    idc = models.ForeignKey('IDC', verbose_name=u'IDC机房', null=True, blank=True, on_delete=False)
...
class SecurityDevice(models.Model):
    asset = models.OneToOneField('Asset', on_delete=False)
...
class NetworkDevice(models.Model):
    ...
    firmware = models.ForeignKey('Software', blank=True, null=True, on_delete=False)
...
class Server(models.Model):
    ...
    hosted_on = models.ForeignKey('self', related_name='hosted_on_server', blank=True, null=True,
                                  on_delete=False)  # for vitural server
...
class RAM(models.Model):
    asset = models.ForeignKey('Asset', on_delete=False)
...
class BusinessUnit(models.Model):
    parent_unit = models.ForeignKey('self', related_name='parent_level', blank=True, null=True,on_delete=False)
...
class Tag(models.Model):
    ...
    creater = models.ForeignKey('UserProfile',on_delete=False)
    create_date = models.DateField(auto_now_add=True)
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey('UserProfile', verbose_name=u'事件源',on_delete=False)
    memo = models.TextField(u'备注', blank=True, null=True)
...
class NewAssetApprovalZone(models.Model):
    ...
    approved_by = models.ForeignKey('UserProfile', verbose_name=u'批准人', blank=True, null=True,on_delete=False)
