...
def raminfo():
    ...
    ram_item_to_dic = {}
    ram_item_to_dic['capacity'] = 0
    ram_item_to_dic['model'] = 'DDR3'
    ram_item_to_dic['manufactory'] = 'Manufacturer04'
    ram_item_to_dic['sn'] = '15441ACF'
    ram_item_to_dic['asset_tag'] = 'AssetTagNum4'
    ram_item_to_dic['slot'] = 'DIMM4'
